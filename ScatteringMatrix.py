...
#substitute sin(Fi2) = (1-cos(Fi2)**2)**2 to get cosFi2 (Kathy)
...
def scatmatr(structure,lam,NSinFi,pol):
    ...
    for i in range(len(structure)-1):
        ...
        # equation 6-9 in the Centurioni paper
        # the cosFi2 is for these eqs
    ...
    #calculates phase shift matrices (eq 11)
    phamatrix=[]
...
#example: c is for coherent, i for incoherent, / is the interface
...
def det(S):#compute determinant |S| = ad - bc
